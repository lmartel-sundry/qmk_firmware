...
// Mid-initialization hook
// Set default lighting, but allow overwrite from EEPROM
void matrix_init_user(void) {

  // enable rgb
  rgblight_enable_noeeprom();

  // set the color to pale pink
  uint8_t h = 359 * (255.0 / 360);
  uint8_t s = 65 * (255.0 / 100);
  uint8_t v = 68; // exactly 4 steps from 0; from 25 * (255.0 / 100)
...
[0] = LAYOUT_65_ansi(
  ...
  KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,                             KC_RALT, XXXXXXX, MO(1),   KC_LEFT, KC_DOWN, KC_RGHT),
